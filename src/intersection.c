...
/*   Updated: 2025/02/21 04:58:07 by ayel-mou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double get_horizontal_intersection(t_cub *cub, t_rays *rays)
{
    ...
    horizontal.inter_x = cub->player_x + (horizontal.inter_y - cub->player_y) / tan(horizontal.angle); // Corrected relationship
...
double get_vertical_intersection(t_cub *cub, t_rays *rays)
{
    ...
    vertical.inter_y = cub->player_y + (vertical.inter_x - cub->player_x) * tan(vertical.angle); // Corrected relationship
